<template>
  <div class="lesson1-1 lesson-tutorial-area animate__animated"
    v-bind:class="{ 
      animate__fadeOutLeft: isActive,
      animate__fadeInLeft: !isActive,
    }">
    <h1>フィッシング詐欺とは？</h1>
    <div class="lesson1-tutorial-content1">
      <span>フィッシング詐欺とは、ユーザーIDやパスワード、クレジットカード情報や住所等の情報を不正に取得する詐欺のことです。<br>
        緊急メールを模したメールを送りつけ、本物そっくりに作った偽サイトでログインさせたりすることで、情報を抜き取られます。
      </span>
...
.lesson1-tutorial-content1 {
  height: calc(100% - 96px);
}
.phishing-hero-container {
  width: 100%;
  height: 100%;
  padding: 0 3%;
  display: flex;
